pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/hunterds'                                                                    //<------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/hunterds-miamioh/hunterds-225-lab3-7.git'                                    //<------change this
        KUBECONFIG = credentials('hunterds-225')                                                         //<------change this
    }
        ...
        stage ("Run Security Checks") {
            steps {
                ...
                sh '''
                    ...
                    -e BURP_START_URL=http://10.48.10.156 \
